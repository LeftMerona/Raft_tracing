Shader "FireParticles_Amplify_AlphaBlended" {
	Properties {
		...
		_UV_Slide2 ("UV_Slide2", Range(-1, 1)) = 0
		_UV_Slide1 ("UV_Slide1", Range(-1, 1)) = 0
		_AlphaMultiplier ("AlphaMultiplier", Range(1, 3)) = 2
		_Turbulence_Tiling ("Turbulence_Tiling", Range(0, 4)) = 1
	}
